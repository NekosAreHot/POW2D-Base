...
//Imported from updated assets
Game.Level.maps = {};

Game.Level.fillCol = function(y){
	for(var i = 0; i < Game.Screen.getHeight(); i += 20){
		Game.createWall(i,y);
	}
}
Game.Level.FillArea = function(x ,y ,height ,width ,texture){
	var h = height * 20;
	var w = width * 20;
	for(var i = 0; i < Game.Screen.getWidth(); i += 20){
		Game.Level.fillCol(i);
	}
}
