Game.levelOne = function(){
	...
	//Starting Room
		...
		Game.createChest(100,200,[Game.getRandomItem(),Game.getRandomItem()]);
		Game.createChest(340,280,[Game.getRandomItem(),Game.getRandomItem(),Game.getRandomItem()]);
		Game.createTree(320,180);
		Game.createTree(340,220);
		//Entities
		Game.Entities.createGhost(100,220,15 * Game.Level.depth);
		Game.wallPrefix();
